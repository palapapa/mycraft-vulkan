...
// NOLINTBEGIN(cppcoreguidelines-avoid-non-const-global-variables): No choice here if I want a global logger.
inline auto global_logger = static_cast<quill::Logger *>(nullptr);
// NOLINTEND(cppcoreguidelines-avoid-non-const-global-variables)

inline auto setup_logger(quill::LogLevel log_level) {
    quill::Backend::start();
